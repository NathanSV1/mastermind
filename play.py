...
if __name__ == '__main__':
    ...
    #from codebreakers import codebreaker0
    #from codemakers import codemaker0
    #for i in range(50):
    #    play(codemaker0, codebreaker0)

    #  Faire jouer un humain contre codemaker0.py :
    #from codemakers import codemaker0
    #from codebreakers import human_codebreaker
    ...
    #from codemakers import human_codemaker
